...
var grammar = {
    ...
    {"name": "action", "symbols": ["set_opt", "action$ebnf$2"]},
    ...
    {"name": "options_conf", "symbols": ["next_opt"]},
    {"name": "options_conf", "symbols": ["set_opt"]},
    ...
    {"name": "next_opt", "symbols": [(lexer.has("NEXT") ? {type: "NEXT"} : NEXT), (lexer.has("COLON") ? {type: "COLON"} : COLON), (lexer.has("IDENT") ? {type: "IDENT"} : IDENT), "next_opt$ebnf$1"]},
    ...
    {"name": "set_opt", "symbols": [(lexer.has("SET") ? {type: "SET"} : SET), (lexer.has("COLON") ? {type: "COLON"} : COLON), (lexer.has("IDENT") ? {type: "IDENT"} : IDENT), "set_opt$ebnf$1"]},
