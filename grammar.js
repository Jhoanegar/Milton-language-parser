...
var grammar = {
    ...
    {"name": "termblock$ebnf$1", "symbols": []},
    {"name": "termblock$ebnf$1", "symbols": ["termblock$ebnf$1", "action"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "termblock$ebnf$2", "symbols": [(lexer.has("NL") ? {type: "NL"} : NL)]},
    {"name": "termblock$ebnf$2", "symbols": ["termblock$ebnf$2", (lexer.has("NL") ? {type: "NL"} : NL)], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "termblock", "symbols": [(lexer.has("LBRACE") ? {type: "LBRACE"} : LBRACE), "termblock$ebnf$1", (lexer.has("RBRACE") ? {type: "RBRACE"} : RBRACE), "termblock$ebnf$2"]},
    {"name": "action", "symbols": [(lexer.has("KEYWORD") ? {type: "KEYWORD"} : KEYWORD)]},
    {"name": "action$ebnf$1", "symbols": ["options_stmt"]},
    {"name": "action$ebnf$1", "symbols": ["action$ebnf$1", "options_stmt"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    ...
    {"name": "action", "symbols": [(lexer.has("OPTIONS") ? {type: "OPTIONS"} : OPTIONS), (lexer.has("COLON") ? {type: "COLON"} : COLON), (lexer.has("LBRACE") ? {type: "LBRACE"} : LBRACE), "action$ebnf$1", (lexer.has("RBRACE") ? {type: "RBRACE"} : RBRACE), "action$ebnf$2"]},
    ...
    {"name": "kyw_opt$ebnf$1$subexpression$1", "symbols": [(lexer.has("NL") ? {type: "NL"} : NL)]},
    {"name": "kyw_opt$ebnf$1$subexpression$1", "symbols": [(lexer.has("_") ? {type: "_"} : _)]},
    {"name": "kyw_opt$ebnf$1", "symbols": ["kyw_opt$ebnf$1", "kyw_opt$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "kyw_opt", "symbols": [(lexer.has("KEYWORD") ? {type: "KEYWORD"} : KEYWORD), (lexer.has("COLON") ? {type: "COLON"} : COLON), (lexer.has("OPT_STRING") ? {type: "OPT_STRING"} : OPT_STRING), "kyw_opt$ebnf$1"]},
    {"name": "kyw_opt$ebnf$2", "symbols": []},
    {"name": "kyw_opt$ebnf$2$subexpression$1", "symbols": [(lexer.has("NL") ? {type: "NL"} : NL)]},
    {"name": "kyw_opt$ebnf$2$subexpression$1", "symbols": [(lexer.has("_") ? {type: "_"} : _)]},
    {"name": "kyw_opt$ebnf$2", "symbols": ["kyw_opt$ebnf$2", "kyw_opt$ebnf$2$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "kyw_opt", "symbols": [(lexer.has("KEYWORD") ? {type: "KEYWORD"} : KEYWORD), (lexer.has("COLON") ? {type: "COLON"} : COLON), (lexer.has("IDENT") ? {type: "IDENT"} : IDENT), "kyw_opt$ebnf$2"]},
